// Import InboxSDK background.js script to enable the necessary functionality
try {
...
//
function runSearchQueryBG(request/*, sender, sendResponse*/) {
...
chrome.runtime.onMessage.addListener(runSearchQueryBG);
